...
class _AudioRelaxScreenState extends State<AudioRelaxScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF8FAF8), // Light sage green background for relaxing audio atmosphere
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios, color: Color(0xFF8FA68E)), // Sage green back arrow
          onPressed: () {
        ...
        title: Text(
          ...
          style: const TextStyle(
            color: Color(0xFF8FA68E), // Sage green title
            fontSize: 20,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                ...
                colors: [Color(0xFF8FA68E), Color(0xFF8FA68E)], // Natural green gradient
              ),
              borderRadius: BorderRadius.circular(20),
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFF8FA68E).withOpacity(0.3), // Green shadow
                  blurRadius: 15,
                    ...
                    children: [
                      Row(
                        children: [
                              ...
                              children: [
                                const Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xFF8FA68E), // Green title
                                  ),
                                ),
                                const SizedBox(height: 8),
                                const Text(
                          ...
                          Container(
                            ...
                            height: 60,
                            decoration: BoxDecoration(
                              color: const Color(0xFF8FA68E).withOpacity(0.2), // Green background
                              borderRadius: BorderRadius.circular(30),
                            ),
                            child: const Icon(
                              Icons.library_music_rounded,
                              color: Color(0xFF8FA68E), // Green icon
                              size: 30,
                            ),
                          ),
                        ],
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(0xFF8FA68E), // Green button
                            borderRadius: BorderRadius.circular(20),
                          ),
                          child: const Text(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    gradient: const LinearGradient(
                      colors: [Color(0xFF8FA68E), Color(0xFF8FA68E)],
                    ),
                    boxShadow: [
                      BoxShadow(
  ...
  List<Color> _getCategoryGradientColors(String categoryName) {
    switch (categoryName.toLowerCase()) {
      case 'nasheed':
      case 'musik islami':
        return [const Color(0xFF8FA68E), const Color(0xFF8FA68E)]; // Natural green
      case 'dzikir dan doa':
      case 'dzikir & doa':
        return [const Color(0xFF8FA68E), const Color(0xFF8FA68E)]; // Reversed natural green
      case 'murottal':
      case 'murrotal':
        return [const Color(0xFF8FA68E), const Color(0xFF8FA68E)]; // Natural green
      default:
        return [const Color(0xFF8FA68E), const Color(0xFF8FA68E)]; // Default natural green
    }
  }
}
