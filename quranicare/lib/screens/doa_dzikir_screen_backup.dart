      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF8FA68E).withOpacity(0.08),
                blurRadius: 12,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  '${_doaDzikirList.indexOf(doaDzikir) + 1}',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Temukan ketenangan jiwa dengan doa dan dzikir pilihan',
                        style: TextStyle(
                          fontSize: 14,
